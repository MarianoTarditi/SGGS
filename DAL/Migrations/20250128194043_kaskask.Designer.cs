...
namespace DAL.Migrations
{
    ...
    [Migration("20250128194043_kaskask")]
    partial class kaskask
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entity.Identity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "86216806-b925-4ba1-979a-dd4f31b6e397",
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "70dfcb84-7d1f-495d-99a9-ddc687c32f9d",
                            Name = "Member",
            ...
            modelBuilder.Entity("Entity.Identity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b4a5c90d-c93e-4980-a9d2-c0f01038008f",
                            Email = "test.video.lesson@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST.VIDEO.LESSON@GMAIL.COM",
                            NormalizedUserName = "TESTADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEPOQ3K0Rfdd2i3hq/a8EUsBBjjym0r5jYHVBbyaH27fucuq87YY32+Jx/uDoXDyyrA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "72600615-50e1-4d94-b58e-0a0696a3e975",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8ba55b5a-8e1a-4ef5-9ab6-e335699e1e99",
                            Email = "test.video.lesson2@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST.VIDEO.LESSON2@GMAIL.COM",
                            NormalizedUserName = "TESTMEMBER",
                            PasswordHash = "AQAAAAIAAYagAAAAEJuHVH6zfbkLnR4uv3TOX/iq5iMftKHUzMypmr/mV7mBYuXqdzXHP3otV3WFeyrRTw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "490e26e1-4e95-48ff-991a-2c936ba69cb6",
                            TwoFactorEnabled = false,
                            UserName = "TestMember"
                        });
                });
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.AutorizacionPago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2025, 1, 28, 16, 40, 42, 399, DateTimeKind.Local).AddTicks(9916),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Deuda", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AsociacionId = 1,
                            CreatedDate = "05/05/2025",
                            FechaVencimiento = new DateTime(2025, 1, 28, 16, 40, 42, 399, DateTimeKind.Local).AddTicks(9773),
                            MiembroId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Evento.AutorizacionEvento", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = "05/05/2025",
                            EstadoAutorizacionId = 1,
                            Fecha = new DateTime(2025, 1, 28, 16, 40, 42, 399, DateTimeKind.Local).AddTicks(9949),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Evento.Evento", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2025, 1, 28, 16, 40, 42, 400, DateTimeKind.Local).AddTicks(842),
                            FechaLlegada = new DateTime(2025, 1, 28, 16, 40, 42, 400, DateTimeKind.Local).AddTicks(843),
                            FechaSalida = new DateTime(2025, 1, 28, 16, 40, 42, 400, DateTimeKind.Local).AddTicks(845),
                            HoraLlegada = new DateTime(2025, 1, 28, 16, 40, 42, 400, DateTimeKind.Local).AddTicks(845),
                            HoraSalida = new DateTime(2025, 1, 28, 16, 40, 42, 400, DateTimeKind.Local).AddTicks(846),
                            JefeDeCampoId = 1,
                            LocacionId = 1,
                            NombreDirecZona = "sad",
                            Telefono = 0.0,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Miembro", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstadoCivilId = 1,
                            EstudioId = 1,
                            FechaNacimiento = new DateTime(2025, 1, 28, 16, 40, 42, 399, DateTimeKind.Local).AddTicks(9847),
                            FuncionId = 1,
                            IdiomaId = 1,
                            LocalidadId = 1,
                            NacionalidadId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.ModalidadPago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedDate = "05/05/2025",
                            FechaDePago = new DateTime(2025, 1, 28, 16, 40, 42, 400, DateTimeKind.Local).AddTicks(356),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Organismo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2025, 1, 28, 16, 40, 42, 400, DateTimeKind.Local).AddTicks(440),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Recibo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Codigo = 1012,
                            CreatedDate = "05/05/2025",
                            Fecha = new DateTime(2025, 1, 28, 16, 40, 42, 400, DateTimeKind.Local).AddTicks(141),
                            PagoId = 1,
                            Total = 3000m
                        });
                });
