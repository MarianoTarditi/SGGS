...
namespace DAL.Migrations
{
    ...
    [Migration("20250306185856_auditoriaAuthentication8")]
    partial class auditoriaAuthentication8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entity.Identity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "611c315a-eb10-4b11-a37d-e3f7c17d7513",
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "2695573c-731b-4511-ac1d-e2e818cde83f",
                            Name = "Member",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "8f44e13c-31d3-4b71-9429-3682087797ef",
            ...
            modelBuilder.Entity("Entity.Identity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0640b2b1-4489-47f6-bebc-487229de0338",
                            Email = "test.video.lesson@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST.VIDEO.LESSON@GMAIL.COM",
                            NormalizedUserName = "TESTADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEBcawnOhLXxYIeJiBRXGc6fB0hOV1/BCTgsh/FjBo/800x3v2LhwNJTK1AqGYybqEA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "25cf6a20-9394-4d3e-8545-a48ea112d0b1",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "ce795105-9508-4b82-be7f-8ea457e8a4bc",
                            Email = "test.video.lesson2@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST.VIDEO.LESSON2@GMAIL.COM",
                            NormalizedUserName = "TESTMEMBER",
                            PasswordHash = "AQAAAAIAAYagAAAAEHwWv2NbCNHEofuSXlsv1u9CjdRdwnVsiT2s6ZfTKNsbN0M8wBmrdASJSbpRxj3d+A==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "a5d0c50d-3262-48c0-9dab-18b8c76726e0",
                            TwoFactorEnabled = false,
                            UserName = "TestMember"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d245b1bd-5e39-434a-b08c-a1eb4959b4c2",
                            Email = "jorgemartinez@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "JORGEMARTINEZ@GMAIL.COM",
                            NormalizedUserName = "JORGE",
                            PasswordHash = "AQAAAAIAAYagAAAAEO2FOluTyiypUm2Vj+oJXP2alOf/5hXCmARlWXPlHMx6JhXP0/DSZhXtYUrN6ISVNQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "3508fdd1-86a0-47e4-8cbc-94dd2a965d16",
                            TwoFactorEnabled = false,
                            UserName = "jorge"
                        });
                });

            modelBuilder.Entity("Entity.Identity.Entities.AuditLogAuthorization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AuditLogsAuthorizations");
                });
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.AutorizacionPago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2025, 3, 6, 15, 58, 55, 618, DateTimeKind.Local).AddTicks(1337),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Deuda", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = "05/05/2025",
                            DeudaPendiente = true,
                            FechaCreacion = new DateTime(2025, 3, 6, 15, 58, 55, 618, DateTimeKind.Local).AddTicks(1203),
                            FechaVencimiento = new DateTime(2025, 3, 6, 15, 58, 55, 618, DateTimeKind.Local).AddTicks(1191),
                            MiembroId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Miembro", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstadoCivilId = 1,
                            EstudioId = 1,
                            FechaNacimiento = new DateTime(2025, 3, 6, 15, 58, 55, 618, DateTimeKind.Local).AddTicks(1280),
                            FuncionId = 1,
                            IdiomaId = 1,
                            InsigniaMadera = true,
                            LocalidadId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.ModalidadPago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedDate = "05/05/2025",
                            FechaDePago = new DateTime(2025, 3, 6, 15, 58, 55, 618, DateTimeKind.Local).AddTicks(1587),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Organismo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2025, 3, 6, 15, 58, 55, 618, DateTimeKind.Local).AddTicks(1673),
