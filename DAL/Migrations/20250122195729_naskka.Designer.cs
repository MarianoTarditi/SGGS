...
namespace DAL.Migrations
{
    ...
    [Migration("20250122195729_naskka")]
    partial class naskka
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entity.Identity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "28b45fc0-1158-4a6d-986e-4ec1069b4635",
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "bd38ac23-c149-4153-bedb-59f3f86d1472",
                            Name = "Member",
            ...
            modelBuilder.Entity("Entity.Identity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "063b661a-7149-4374-a42a-a4517a8389bd",
                            Email = "test.video.lesson@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST.VIDEO.LESSON@GMAIL.COM",
                            NormalizedUserName = "TESTADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEMQJtDqK4MBMu9ix7iOFU5Mr43B9gSCM/Lqm9W0bpc2Wd6yXh2B9Ifa/nrim8jQCCw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "61519d6d-5456-405d-ad9d-368ed1dced78",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "648ae05a-97d7-4810-ba97-1bbd3984676e",
                            Email = "test.video.lesson2@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST.VIDEO.LESSON2@GMAIL.COM",
                            NormalizedUserName = "TESTMEMBER",
                            PasswordHash = "AQAAAAIAAYagAAAAEAXed6jdaJ/y3wKcvbtAkkfbVfO/iGUAiDWr96SGg3O2c8+SEKG++J0HHLbz9IH+BQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "5fcf1d70-29f9-4701-aead-ee47ad042ba0",
                            TwoFactorEnabled = false,
                            UserName = "TestMember"
                        });
                });
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.AutorizacionPago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = "05/05/2025",
                            Estado = "Aprobado",
                            Fecha = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(77),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Deuda", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AsociacionId = 1,
                            CreatedDate = "05/05/2025",
                            FechaVencimiento = new DateTime(2025, 1, 22, 16, 57, 29, 80, DateTimeKind.Local).AddTicks(9940),
                            MiembroId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Evento.AutorizacionEvento", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = "05/05/2025",
                            Estado = "Aprobado",
                            Fecha = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(44),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Evento.Evento", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(866),
                            FechaLlegada = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(867),
                            FechaSalida = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(869),
                            HoraLlegada = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(871),
                            HoraSalida = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(871),
                            JefeDeCampoId = 1,
                            LocacionId = 1,
                            NombreDirecZona = "sad",
                            Telefono = 0.0,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Miembro", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstadoCivilId = 1,
                            EstudioId = 1,
                            FechaNacimiento = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(9),
                            FuncionId = 1,
                            IdiomaId = 1,
                            LocalidadId = 1,
                            NacionalidadId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.ModalidadPago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedDate = "05/05/2025",
                            FechaDePago = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(401),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Organismo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Direccion = "Dardo rocha 78",
                            FechaCreacion = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(503),
                            LocalidadId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Recibo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Codigo = 1012,
                            CreatedDate = "05/05/2025",
                            Fecha = new DateTime(2025, 1, 22, 16, 57, 29, 81, DateTimeKind.Local).AddTicks(249),
                            PagoId = 1,
                            Total = 3000m
                        });
                });
