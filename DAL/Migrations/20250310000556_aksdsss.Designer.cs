...
namespace DAL.Migrations
{
    ...
    [Migration("20250310000556_aksdsss")]
    partial class aksdsss
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entity.Identity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ef2b2cdb-9ac7-4b11-8e73-719f12fcea03",
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "d84bba56-6138-4e6f-8475-6041e15fa44a",
                            Name = "Member",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "58382c93-b088-405d-87ba-dcb846285a78",
            ...
            modelBuilder.Entity("Entity.Identity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b6ec2373-1f6e-466d-8a22-fd7fa5ea28bf",
                            Email = "test.video.lesson@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST.VIDEO.LESSON@GMAIL.COM",
                            NormalizedUserName = "TESTADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAENUga5dLNGE97Fcczp/2Ro9WvJ8o4u+mJazHZ0KOwJKT19UFX6uxtoZguhx0eKpjYA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "7dd3d6b9-9e41-4083-8928-42de4a6fd417",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a0ddc17d-c581-4622-a2de-46a6f8404fe6",
                            Email = "test.video.lesson2@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TEST.VIDEO.LESSON2@GMAIL.COM",
                            NormalizedUserName = "TESTMEMBER",
                            PasswordHash = "AQAAAAIAAYagAAAAECcrFivHciwRDgvqbJxDL7ERpMQqW+3Ijs0G6DmdHvtKjqkPljmhkyEtFAJmyIbV9g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "163a9568-e861-4b22-9cdb-fa0a35eb3a93",
                            TwoFactorEnabled = false,
                            UserName = "TestMember"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "aed568a0-2051-4169-9c83-b00c468652ef",
                            Email = "jorgemartinez@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "JORGEMARTINEZ@GMAIL.COM",
                            NormalizedUserName = "JORGE",
                            PasswordHash = "AQAAAAIAAYagAAAAEETpZUNxO+C6ojjk6KJKgLa0uRczDZm8WUvk66/lU6UMw5SWI2+eGatcVnnCSNJ3vA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "553060fb-d4e9-4cbf-976d-8034786bbe02",
                            TwoFactorEnabled = false,
                            UserName = "jorge"
                        });
                });
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.AutorizacionPago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2025, 3, 9, 21, 5, 54, 897, DateTimeKind.Local).AddTicks(7573),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Deuda", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = "05/05/2025",
                            DeudaPendiente = true,
                            FechaCreacion = new DateTime(2025, 3, 9, 21, 5, 54, 897, DateTimeKind.Local).AddTicks(7339),
                            FechaVencimiento = new DateTime(2025, 3, 9, 21, 5, 54, 897, DateTimeKind.Local).AddTicks(7334),
                            MiembroId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Miembro", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EstadoCivilId = 1,
                            EstudioId = 1,
                            FechaNacimiento = new DateTime(2025, 3, 9, 21, 5, 54, 897, DateTimeKind.Local).AddTicks(7434),
                            FuncionId = 1,
                            IdiomaId = 1,
                            InsigniaMadera = true,
                            LocalidadId = 1,
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.ModalidadPago", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedDate = "05/05/2025",
                            FechaDePago = new DateTime(2025, 3, 9, 21, 5, 54, 897, DateTimeKind.Local).AddTicks(7861),
            ...
            modelBuilder.Entity("Entity.WebAplication.Entities.Organismo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FechaCreacion = new DateTime(2025, 3, 9, 21, 5, 54, 897, DateTimeKind.Local).AddTicks(7970),
